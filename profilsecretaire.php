...
<body>
  ...
  <section><h3 class="custom-heading">Profile</h3>
    <form action="modifier_secretaire.php" method="post" enctype="multipart/form-data">

      <div class="row">
          <div class="col-lg-4">
              <div class="card mb-4">
                  <div class="card-body text-center">
                  <img src="uploads/<?php echo $row["image"]; ?>" alt="secretaire" class="rounded-circle img-fluid" style="width: 150px;">
                      ...
                      <?php echo "<p class='text-muted mb-0'>" . $row["genre"] . "</p>"; ?><hr>
                      <?php echo "<p class='text-muted mb-0'>" . $row["datedenaissance"] . "</p>"; ?><hr>
      ...
      <div class="card mb-4">
          <div class="card-body">
              <form action="modifier_medecin.php" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
                      <div class="col-sm-3">
                          <p class="mb-0"> Date_naissance</p>
                      </div>
                      <div class="col-sm-9">
                          <input type="date" name="datedenaissance" value="<?php echo $row['datedenaissance']; ?>">
                      </div>
                  </div>
                  <hr>
                  <div class="row">
    ...
    <div class="col-sm-9">
        <label>
            <input type="radio" name="genre" value="homme" <?php if ($row['genre'] == 'homme') echo 'checked'; ?>>
            Homme
        </label>
        <label>
            <input type="radio" name="genre" value="femme" <?php if ($row['genre'] == 'femme') echo 'checked'; ?>>
            Femme
        </label>
    </div>
</div>
