            ...
            <div class="table-wrap">
              <table class="table table-responsive">
                ...
                <tbody>
                  ...
                  // Vérifier si un numéro de CIN Patient a été saisi dans le formulaire
                  if (isset($_GET['cin'])) {
                    // Échapper les caractères spéciaux pour éviter les injections SQL
                    $cin = $connexion->real_escape_string($_GET['cin']);
                    // Requête SQL pour sélectionner les rendez-vous du patient avec le numéro de CIN spécifié
                    $sql = "SELECT * FROM rdv WHERE telephone IN (SELECT telephone FROM patient WHERE cin = '$cin')";
                    ...
                    if (mysqli_num_rows($resultat) > 0) {
                      ...
                      echo "<tr><td colspan='8'>Aucun rendez-vous trouvé pour ce patient</td></tr>";
                    }
                  } else {
                    echo "<tr><td colspan='8'>Veuillez saisir un numéro de CIN Patient pour effectuer la recherche</td></tr>";
                  }
